...
if (isset($_GET['admin_folder_name'])) {
    ...
    if ($folderResult && mysqli_num_rows($folderResult) > 0) {
        ...
        if (json_last_error() === JSON_ERROR_NONE && is_array($sharedList) && in_array($loggedInUser, $sharedList)) {
            // Fetch the files if the user is authorized
...
<head>
    ...
    <title><?php echo htmlspecialchars($admin_folder_name); ?> Folders</title>
</head>
...
<body>
    <main>
        ...
        <div class="container">
            <h1><a class="navLink" href="#" onclick="window.history.back(); return false;">Shared with me</a> > <?php echo htmlspecialchars($admin_folder_name); ?></h1>
                        ...
                        <?php while ($aline = mysqli_fetch_array($fetch)) { ?>
                            <tr class="file-row"
                                ...
                                <td>
                                    ...
                                    $maxLength = 40; // Set the maximum number of characters to display
                                ...
                                <td>
                                    <div class="folderDiv">
                                        ...
                                        <?php echo htmlspecialchars($aline["admin_file_folder"]); ?>
                                    </div>
                                </td>
                                <td>
                                    <?php
    ...
    <div class="context-menu" id="contextMenu">
        ...
        <form action="../remote/deleteFile.php" method="POST">
            ...
            <input type="submit" value="Delete" name="delete3">
        </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const sharedFolderActive = document.getElementById('sharedFolderActive');
            sharedFolderActive.classList.toggle('active');
