        ...
        <form action="../remote/newFile.php" method="POST" enctype="multipart/form-data">
            <div class="divs">
                ...
                <div class="file-upload-container" onclick="triggerFileInput()">
                    <!-- Hidden file input -->
                    <input type="file" id="admin_file_name" name="admin_file_name" style="display: none;" required onchange="displayFileName()" />
                    <!-- SVG icon -->
                    
                    <div class="upload-icon">

                    <span id="file-name-display" style="cursor: pointer;">click to Upload</span>
