...
<body>
    ...
    $get = "SELECT * FROM admin_file WHERE admin_file_owner_name = '$loggedInUser'";
    ...
    <main>
        <div class="container">
            <h1><?php echo $loggedInUser ?>'s Files</h1>
                    ...
                    <tbody>
                        <?php while ($aline = mysqli_fetch_array($fetch)) { ?>
                            <tr class="file-row"
                                ...
                                <td>
                                    <a href="../remote/downloadFile.php?admin_file_name=<?php echo $aline['admin_file_name']; ?>" class="design" onclick="event.stopPropagation();">
            ...
            <?php else: ?>
                <div class="empty-message">
                    ...
                    No files available in your account.
                </div>
            <?php endif; ?>
        </div>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            renameBtn.addEventListener('click', () => {
                ...
                const fileName = renameBtn.getAttribute('data-file-name');
