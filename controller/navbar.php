...
<body>
    ...
    <script>
        ...
        // Function to trigger file input on span click
        document.getElementById('file-name-display').onclick = function() {
            document.getElementById('admin_file_name').click();
        };

        // Function to display selected file name
        function displayFileName() {
            var fileInput = document.getElementById('admin_file_name');
